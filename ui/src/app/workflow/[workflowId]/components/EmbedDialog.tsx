...
export function EmbedDialog({
                                            ...
                                            <div className="space-y-3">
                                                <div className="rounded-lg bg-muted/50 p-4">
                                                    ...
                                                    <ul className="text-sm space-y-2 text-muted-foreground">
                                                        ...
                                                        <li>• Call window.ENXTWidget.start() to begin the call</li>
                                                        <li>• Call window.ENXTWidget.end() to end the call</li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div className="rounded-lg bg-blue-50 dark:bg-blue-950/20 p-4 border border-blue-200 dark:border-blue-800">
                                                    ...
                                                    <pre className="text-xs overflow-x-auto">
                                                        <code className="text-blue-800 dark:text-blue-200">{`export function ENXTAgent() {
  const [isCallActive, setIsCallActive] = useState(false);

  useEffect(() => {
    // Widget will auto-initialize when script loads
    window.ENXTWidget?.onCallStart(() => {
      setIsCallActive(true);
    });
    window.ENXTWidget?.onCallEnd(() => {
  ...
  return (
    <div className="my-8">
      ...
      <div id="enxt-inline-container" className="min-h-[400px]">
        {/* Widget renders here */}
      </div>
      <button
        onClick={() => window.ENXTWidget?.start()}
