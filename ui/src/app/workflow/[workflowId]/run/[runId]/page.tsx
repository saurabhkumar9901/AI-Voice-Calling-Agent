...
import { downloadRunArtifact, RunArtifactKind } from '@/lib/files';
...
export default function WorkflowRunPage() {
    ...
    const handleDownloadArtifact = async (kind: RunArtifactKind) => {
        try {
    ...
    const fetchWorkflowRun = useCallback(async () => {
        ...
        setWorkflowRun({
            ...
            call_summary: (response.data as unknown as { call_summary?: string | null })?.call_summary ?? null,
            ...
            <div className="flex h-screen w-full overflow-hidden">
                ...
                <div className="w-2/3 h-full overflow-y-auto">
                    ...
                    <Card className="border-border">
                        ...
                        <CardContent>
                            <p className="text-muted-foreground mb-8">Your voice agent run has been completed successfully. You can read the call summary, and preview or download the transcript and recording.</p>
                            ...
                            <div className="flex flex-wrap gap-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <MediaPreviewButton
                                        ...
                                        hasRecording={!!workflowRun?.recording_url}
                                        hasTranscript={!!workflowRun?.transcript_url}
                                ...
                                <div className="flex items-center gap-2 border-l border-border pl-4">
                                    ...
                                    <Button
                                        onClick={() => handleDownloadArtifact('transcript')}
                                    ...
                                    <Button
                                        onClick={() => handleDownloadArtifact('recording')}
                ...
                {/* Summary panel - 1/3 width (falls back to transcript when no summary) */}
                <div className="w-1/3 h-full shrink-0 overflow-hidden">
                    <RealtimeFeedback mode="historical" logs={workflowRun?.logs} summary={workflowRun?.call_summary} />
                </div>
            </div>
        );
    }
        ...
        returnValue =
            <div className="h-full flex items-center justify-center">
                <BrowserCall
                    ...
                    onCallCompleted={fetchWorkflowRun}
