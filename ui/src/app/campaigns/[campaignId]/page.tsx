...
import { ArrowLeft, CalendarIcon, Check, Clock, Download, Pause, Pencil, Play, RefreshCw, Trash2, X } from 'lucide-react';
                ...
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Button
                                variant="outline"
                                disabled={['running', 'syncing'].includes(campaign.state) || isDeleting}
                                title={['running', 'syncing'].includes(campaign.state) ? 'Pause the campaign before deleting it' : 'Delete campaign'}
                ...
                <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                {`Delete "${campaign.name}"? Its queued calls will be removed, but completed call history is kept. This action cannot be undone.`}
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
