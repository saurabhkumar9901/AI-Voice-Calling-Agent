...
class OrganizationConfigurationKey(Enum):
    ...
    WHATSAPP_CONFIGURATION = (
        "WHATSAPP_CONFIGURATION"  # Org-level Meta WhatsApp (Text-only LLM) config
    )
    PROVIDER_CALL_LOGS_URL = (
        "PROVIDER_CALL_LOGS_URL"  # Org-level provider call logs page URL
    )
...
class ToolCategory(Enum):
    ...
    SCHEDULE_CALLBACK = "schedule_callback"  # Schedule a follow-up callback
