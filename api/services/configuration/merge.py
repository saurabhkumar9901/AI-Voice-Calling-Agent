...
SERVICE_FIELDS = ("llm", "tts", "stt", "embeddings", "s2s")
...
def merge_user_configurations(
    ...
    *incoming_partial* is the body of the PUT request (already `model_dump()`ed or
    ...
    # other simple fields
    for simple_field in ["test_phone_number", "timezone", "active_pipeline"]:
        if simple_field in incoming_partial:
            merged[simple_field] = incoming_partial[simple_field]
