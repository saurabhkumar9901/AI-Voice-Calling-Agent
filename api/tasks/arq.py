...
from api.tasks.callback_tasks import check_due_callbacks, place_callback_call
...
class WorkerSettings:
    ...
    # Poll every minute for due follow-up callbacks.
    cron_jobs = [cron(check_due_callbacks, minute=set(range(60)))]
